...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-filter" '("all" "any" "archive" "can-view-statistics" "chat-list" "contact" "custom" "define-telega-filter" "has-" "ids" "inactive-supergroups" "label" "last-message-by-me" "main" "name" "nearby" "not" "online-status" "permission" "pin" "restriction" "saved-messages" "search" "telega-" "top" "tracking" "type" "unmuted" "unread" "verified")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-sort" '("chatbuf-" "define-telega-sorter" "join-date" "member-count" "nearby-distance" "online-members" "order" "telega-" "title" "unread-count")))
