...

;;;### (autoloads nil "helm-slack" "helm-slack.el" (0 0 0 0))
;;; Generated autoloads from helm-slack.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "helm-slack" '("helm-slack")))
...
;;;***

;;;### (autoloads nil "slack-authorize" "slack-authorize.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from slack-authorize.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-authorize" '("slack-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-bot" '("slack-find-bot")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-conversations" '("slack-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-dialog-edit-element-buffer" '("slack-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-message-compose-buffer" '("slack-message-compose-buffer")))
...
;;;***

;;;### (autoloads nil "slack-oauth2" "slack-oauth2.el" (0 0 0 0))
;;; Generated autoloads from slack-oauth2.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-oauth2" '("slack-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-reply" '("slack-reply")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-thread" '("slack-" "thread-mark-url")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-user-message" '("slack-user-message-keymap")))
