...
(custom-theme-set-faces
 'light
 '(default ((((class color) (min-colors 89)) (:foreground "#000000" :background "#ffffff" :family "Iosevka" :slant normal :weight normal :height 98 :width normal))))
 ...
 '(hl-line ((t (:background "#FFFCDD"))))
 '(hs-ellipsis ((t (:background "#E1ECFF" :box (:line-width 1 :color "#1936A6" :style pressed-button)))))
 ...
 '(org-superstar-item ((t (:inherit default :box (:line-width 4 :color "#fff")))))
 '(org-table ((t (:inherit fixed-pitch :foreground "#17178F"))))
 ...
 '(outline-1 ((t (:foreground "#1C5F5D" :weight bold :height 1.5))))
 '(outline-2 ((t (:foreground "#7D872C" :weight bold :height 1.4))))
 '(outline-3 ((t (:foreground "#397E39" :weight bold :height 1.0))))
 '(outline-4 ((t (:foreground "#8E228D" :weight bold :height 1.0))))
 ...
 '(whitespace-line ((t (:background "#E2B3D2"))))
 '(whitespace-space ((t (:foreground "#66CACC"))))
 '(whitespace-trailing ((t (:background "#E7B4F1")))))
