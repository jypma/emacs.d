(custom-set-variables
 ...
 '(custom-safe-themes
   '("50a808e6ffedc0abfad25e11a6208c158df1dc68f1d3cd9d0624afa1ef546838"
     "3b71d9d8571b0199bf420371f38248cbc5dc934e55f3f32cce9ecb04b97ed881"
 ...
 '(lsp-java-vmargs
   '("-javaagent:/home/jan/.cache/lombok.jar" "-noverify" "-Xmx8G"
 ...
 '(markdown-code-lang-modes
   '(("ocaml" . tuareg-mode) ("elisp" . emacs-lisp-mode)
     ...
     ("shell" . sh-mode) ("bash" . sh-mode) ("js" . javascript-mode)
     ("json" . js-json-mode)))
 ...
 '(safe-local-variable-values
   '((magit-todos-exclude-globs "elpa") (eval outline-hide-sublevels 1)))
 '(whitespace-line-column 110)
 '(whitespace-style
   '(face trailing tabs lines-tail newline missing-newline-at-eof empty
          space-after-tab space-before-tab tab-mark))
 '(world-clock-list
   '(("UTC" "UTC") ("Europe/Copenhagen" "Copenhagen")
     ("Europe/Kiev" "Kiev") ("Asia/Kuala_Lumpur" "Kuala Lumpur")
