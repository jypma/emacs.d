(custom-set-variables
 ...
 '(lsp-java-configuration-maven-user-settings "/home/jan/.emacs/m2-settings.xml")
 ...
 '(lsp-metals-java-home "/usr/lib/jvm/java-21-openjdk")
 '(lsp-metals-server-args '("-Dmetals.loglevel=debug"))
 '(lsp-ui-doc-enable t)
...
(custom-set-faces
 ...
 '(gnus-header ((t nil)))
 '(highlight-symbol-face ((t (:background "#435113" :foreground "#EDEA32"))))
